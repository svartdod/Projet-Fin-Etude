        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Tasks </a>
             ...
             <li><a href="download" > <img src="https://png.icons8.com/download/p1em/26/666666"> Download </a>
             ...
             <li><a href="#sugg" aria-expanded="false" data-toggle="collapse"><img src="https://png.icons8.com/thinking-male/ios7/26/666666"> Suggestion </a>
              <ul id="sugg" class="collapse list-unstyled">
               ...
               <li class="active"><a href="#help" aria-expanded="false" data-toggle="collapse"> <img src="https://png.icons8.com/help/ios7/26/666666"> Help </a>
              <ul id="help" class="collapse list-unstyled">
                <li><a href="#"><img src="https://png.icons8.com/faq/ios7/26/666666"> FAQs</a></li>
                    ...
                    <div class="card-body">
                      <form action="action.php" method="POST"  class="form-horizontal">
                        ...
                        <div class="form-group row has-success">
                           <div class="col-md-12">
                      <button type="button" data-toggle="collapse" data-target="#nn" class="btn btn-primary btn-lg btn-block">How do I download all superclass in one folder ? </button>

                      <button type="button" data-toggle="collapse" data-target="#nn" class="btn btn-primary btn-lg btn-block">How do I suggest a object,action or actor ? </button>

                                            <button type="button" data-toggle="collapse" data-target="#nn" class="btn btn-primary btn-lg btn-block">How do I download only the superclass that contain ‘cars’ (or some other object) ? </button>
                                            <button type="button" data-toggle="collapse" data-target="#nn" class="btn btn-primary btn-lg btn-block">i want a description about my scene  </button>

                      <button type="button" data-toggle="collapse" data-target="#nn" class="btn btn-primary btn-lg btn-block">How to create an account ? </button>
