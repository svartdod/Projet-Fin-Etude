        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Tasks </a>
             ...
             <li class="active"><a href="#sugg"  data-toggle="collapse" aria-expanded="true"><img src="https://png.icons8.com/thinking-male/ios7/26/666666"> Suggestion </a>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Suggest your object</h3>
                    </div>
                    <div class="card-body">
                      <form  action="forms.php" method="POST" class="form-horizontal">
                          ...
                          <div class="col-sm-9">
                            <div class="row">
							  ...
							  <div class="col-md-4">
								...
								<label class="row-sm-3 form-control-label">Object</label>
                        ...
                        <div class="form-group row">
                          ...
                          <label class="col-sm-3 form-control-label">Choose your object</label>
                          ...
                          <div class="col-sm-9">
                            ...
                            <select name="Object" class="form-control">
                              ...
                              while($row=$resultat->fetch(PDO::FETCH_ASSOC))
                                { 
                                  echo '<option value="'.$row['NameObj'].'">'.$row['NameObj'].'</option>';
                                }
                              ...
                              <div class="col-md-3">
                                <select name="Poid" class="form-control" onchange="myFunction(this.value)">
                              ...
                              <option value="Less_Frequent">Less Frequent</option>
									...
									<label class="col-sm-3 form-control-label">Other object</label>

									<div  id="otherobj"class="col-md-5">
									
									<input type="text" name="otherr" placeholder="" class="form-control">
