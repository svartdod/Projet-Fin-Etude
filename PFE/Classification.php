...
{
    if(isset($_POST['Claaaaaass']) || isset($_POST['classs']))
    {
      require "classe.php";
      traitement();
    }
    if (isset($_POST['downloadd']))
    {
      ...
      download_classi($database,$_POST['txtScript'],$_POST['actionss'],$_POST['ACTS']);
    }
    if(isset($_POST['downs']))
    {
      require "download_all.php";
      download_classi($database,$_POST['obj3'],$_POST['act3'],$_POST['actts']);
    }
    if(isset($_POST['classfinal']))
    {
      require "CLASS.php";
      Classification();
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Classification</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Classifier</h3>
                    </div>
                    <div class="card-body">
                      <form method="POST" action ="Classification.php" class="form-horizontal">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul id="tabsJustified" class="nav nav-tabs">
                    <li class="nav-item"><a href="" data-target="#profile1" data-toggle="tab" class="nav-link small text-uppercase active" >Medium classifier </a></li>
                    <li class="nav-item"><a href="" data-target="#profile2" data-toggle="tab" class="nav-link small text-uppercase ">SVM  classifier</a></li>
                    <li class="nav-item"><a href="" data-target="#messages1" data-toggle="tab" class="nav-link small text-uppercase">Random Forest</a></li>
                ...
                <div id="tabsJustifiedContent" class="tab-content">
                    ...
                    <div id="profile1" class="tab-pane fade active show">
                      <h2><p class="font-italic">Classifier your scene</p></h2>
...
Total word Count : <span id="d_a">0</span> words. Words left : <span id="w_a">3</span></br> 
 ...
 <button name="Claaaaaass" type="submit" class="btn btn-primary">Classifier</button>
 <button name="downloadd" type="submit" class="btn btn-primary">Download</button>
					 ...
					 <div id="profile2" class="tab-pane fade">
                      <h2><p class="font-italic">SVM classifier </p></h2>
                      <p></p> 
                      <p>Describe your scene,objects,actions and actors</p> 
...
Total word Count : <span id="d_aa">0</span> words. Words left : <span id="w_aa">1</span></br> 
 ...
 <button name="classs" type="submit" class="btn btn-primary">Classifier</button>
 <button name="downs" type="submit" class="btn btn-primary">Download</button>
                    ...
                    <div id="messages1" class="tab-pane fade">
                      <h2><p class="font-italic">Classifier your input data :</p></h2>
                      <p></p> 
                      <p>Describe your scene,objects,actions and actors</p> 
                       <br>Tell us about objects in your scene </br> 
					<textarea name="object15" id="object15" ></textarea> 
                      <br>
Total word Count : <span id="display15">0</span> words. Words left : <span id="word15">5</span></br>
                      <p></p>
                       <br>Tell us about actions in your scene </br> 
                      <textarea name="action15" id="action15" ></textarea>

                        <br>
Total word Count : <span id="daction15">0</span> words. Words left : <span id="waction15">3</span></br>
            


             <br>Tell us about acteurs in your scene </br> 
                      <textarea name="acteur15" id="acteur15" ></textarea>
                      Total word Count : <span id="display15">0</span> words. Words left : <span id="word15">3</span></br>

                      
                       <div class="col-md-12">    
   <label class="col-sm-5 form-control-label"></label>
 
 <button name="classfinal" type="submit" class="btn btn-primary">Classifier</button>
</
