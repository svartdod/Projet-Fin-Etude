...
<div class="avatar"><img src="img/man.png" alt="..." class="img-fluid rounded-circle"></div>            <div class="title">
              <?php 
            ...
            <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Tasks </a>
             ...
             <li class="active" ><a href="#sugg" aria-expanded="false" data-toggle="collapse"><img src="https://png.icons8.com/thinking-male/ios7/26/666666"> Suggestion </a>
              <ul id="sugg" class="collapse list-unstyled">
                ...
                <li class="active"><a href="suggactor.php"><img src="https://png.icons8.com/man/ios7/26/666666"> Suggest an Actor</a></li>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Suggest your Actor</h3>
                    </div>
                    <div class="card-body">
                      <form  action="suggactor.php" method="POST" class="form-horizontal">
                          ...
                          <div class="col-sm-9">
                            <div class="row">
							  ...
							  <div class="col-md-4">
								...
								<label class="row-sm-3 form-control-label">Actor</label>
                        ...
                        <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Choose your Actor</label>
                          ...
                          <div class="col-sm-9">
                            ...
                            <select name="Actor" class="form-control" >
                             <?php 
                              ...
                              <div class="col-md-3">
                                <select name="Poid" class="form-control" >
                              ...
                              <option value="Less_Frequent">Less Frequent</option>
							        ...
							        <div id="lino" name="lino" class="line"> </div>
                                        <label class="col-sm-3 form-control-label">Other Actor</label>
